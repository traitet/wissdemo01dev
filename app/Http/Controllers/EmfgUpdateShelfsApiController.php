...
// ==========================================================================
    ...
    private $ENDPOINT = 'http://10.100.1.94:8080/wissdemo01/public/api/wiss_atac_emfg_get_shelf';
// ==========================================================================
// GET DATA
// ==========================================================================
    ...
    function update(Request $req)
    {
        ...
        $req->validate([
            ...
            // ======================================================================
            try{
                $result = DB::connection('sqlsrv_atac_arisa_p02_db')->select("EXEC wiss_atac_emfg_maintain_shelf_xml @data = '$queryStr', @USERNAME = '$userName'");
