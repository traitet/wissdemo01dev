...
// DECLARE END POINT
// ==========================================================================
    private $ENDPOINT = 'http://10.40.0.4:8080/wissdemo01/public/api/eps_interface_sap_pr_outstanding_obj';
        ...
        // ==========================================================================
            ...
            if ($response->status() == 200) {
                ...
                if(!empty($result)){
                    ...
                    return view('eps-pr-outstanding', compact('result', 'keyArray','docNumRtv','dateStartRtv','dateEndRtv','maxRecordRtv','permissionName'));
                }else{
