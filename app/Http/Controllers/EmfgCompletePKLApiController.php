...
// DECLARE END POINT
// ==========================================================================
    private $ENDPOINT = 'http://10.40.0.4:8080/wissdemo01/public/api/wiss_atac_emfg_complete_pkl';
        ...
        // ==========================================================================
            ...
            if ($response->status() == 200) {
                ...
                if(!empty($result)){
                    ...
                    return view('wiss-atac-emfg-complete-pkl', compact('result', 'keyArray','permissionName'));
                }else{
