...
// DECLARE END POINT
// ==========================================================================
    private $ENDPOINT = 'http://10.40.0.4:8080/wissdemo01/public/api/wiss_sa_add_eps_investment';
...
// ==========================================================================
    function getData(Request $req)
    {
        ...
        // ======================================================================
            ...
            $optionValue = $req->input('investmentId')??'investmentId is empty';
        // ======================================================================
        // ==========================================================================
        ...
        // ==========================================================================
            ...
            if ($response->status() == 200) {
                ...
                if(!empty($result)){
                    ...
                    return view('wiss-sa-add-eps-investment', compact('result', 'keyArray','permissionName'));
                }else{
