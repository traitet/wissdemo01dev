...
// CLASS DECLARATION
// ==========================================================================
class EpsCpApprovePrApiController extends Controller
{

// ==========================================================================
// DECLARE END POINT
// ==========================================================================
    private $ENDPOINT = 'http://10.100.1.94:8080/wissdemo01/public/api/eps_pr_for_cp_report_obj';
           ...
           // ======================================================================
            ...
            if ($response->status() == 200) {
                ...
                if(!empty($result)){
                    ...
                    return view('eps-cp-approve-pr', compact('result', 'keyArray','docNumRtv','dateStartRtv','dateEndRtv','maxRecordRtv','permissionName'));
                }else{
