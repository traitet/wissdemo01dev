    ...
    'connections' => [
       ...
       //=====================================
        ...
        'sqlsrv_eps_db' => [
            ...
            'host' => env('DB_HOST', 'localhost'),
            'port' => env('DB_PORT', '1433'),
            'database' => env('DB_DATABASE_SIAM_EPSDB', 'forge'),
            'username' => env('DB_USERNAME', 'forge'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
        ...
        //=====================================
        // DB_DATABASE_SIAM_ARISA_P01  (CONFIG AT .ENV)
        //=====================================
        'sqlsrv_siam_arisa_p01_db' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', 'localhost'),
            'port' => env('DB_PORT', '1433'),
            'database' => env('DB_DATABASE_SIAM_ARISA_P01', 'forge'),
            'username' => env('DB_USERNAME', 'forge'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
        ...
        //=====================================
        // DB_DATABASE_ATAC_ARISA_P02  (CONFIG AT .ENV)
        //=====================================
        'sqlsrv_atac_arisa_p02_db' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', 'localhost'),
            'port' => env('DB_PORT', '1433'),
            'database' => env('DB_DATABASE_ATAC_ARISA_P02', 'forge'),
            'username' => env('DB_USERNAME', 'forge'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
        ...
        //=====================================
        // DB_DATABASE_SIAM_LASER_P01  (CONFIG AT .ENV)
        //=====================================
        'sqlsrv_siam_laser_p01_db' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', 'localhost'),
            'port' => env('DB_PORT', '1433'),
            'database' => env('DB_DATABASE_SIAM_LASER_P01', 'forge'),
            'username' => env('DB_USERNAME', 'forge'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
        ...
        //################################################ DEV INSTANT ########################################
        //=====================================
        // DB_DATABASE_SIAM_LASER_D01  (CONFIG AT .ENV)
        //=====================================
        'sqlsrv_siam_laser_d01_db' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', 'localhost'),
            'port' => env('DB_PORT', '1433'),
            'database' => env('DB_DATABASE_SIAM_LASER_D01', 'forge'),
            'username' => env('DB_USERNAME', 'forge'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
        ...
        //=====================================
        // DB_DATABASE_ATAC_ARISA_D02  (CONFIG AT .ENV)
        //=====================================
        'sqlsrv_atac_arisa_d02_db' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', 'localhost'),
            'port' => env('DB_PORT', '1433'),
            'database' => env('DB_DATABASE_ATAC_ARISA_D02', 'forge'),
            'username' => env('DB_USERNAME', 'forge'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
