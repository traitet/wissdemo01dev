    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                {{-- FORM  ACTION = VIEW --}}
                {{-- =============================================================== --}}
                <form method="POST" action="{{ route('FunctionLog.index', $permissionName) }}" id="myForm">
                    @csrf
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if (isset($result)) {
                                                           ?>
                                                                ...
                                                                <th scope="col">Access data time</th>
                                                    ...
                                                    <?php if (isset($result)) {
                                                        foreach ($result as $keyResult) { ?>
                                                            <tr>
                                                                    ...
                                                                    <td>{{$keyResult->id}}</td>
                                                                    <td>{{$keyResult->first_name}}</td>
                                                                    <td>[ {{$keyResult->name}} ]&nbsp; {{$keyResult->permission_name}}</td>
                                                                    <td>{{$keyResult->updated_at}}</td>
                                                                    <td>{{$keyResult->message}}</td>
