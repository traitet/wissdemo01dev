    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                {{-- FORM  ACTION = VIEW --}}
                {{-- =============================================================== --}}
                <form method="POST" action="{{ route('EmfgAddShelfATAC.show', $permissionName) }}" id="myForm">
                    @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="form-group form-inline">
                                                <label for="slocCode">Store Location Code: </label>
                                                <input class="form-control" type="text" class="" id="slocCode" name="slocCode">&nbsp;&nbsp;
                                                <label for="shelfName">Shelf Name: </label>
                                                <input class="form-control" type="text" class="" id="shelfName" name="shelfName">&nbsp;&nbsp;
                                                <label for="shelfCode">Shelf Code: </label>
                                                <input class="form-control" type="text" class="" id="shelfCode" name="shelfCode">&nbsp;&nbsp;
                                            </div>
                                        </div>
                                        <div class="form-group">
