                ...
                @include('theme.navbar')
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h5 mb-0 text-gray-800">【 E-MFG UPDATE MODELS 】</h1>
                        </div>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <div class="form-group float-right">
                                            <div class="row">
                                                <form action="{{ route('EmfgUpdateModelsATAC.import', $permissionName) }}" method="POST" name="form" id="import_excel_form" enctype="multipart/form-data">
                                                @csrf
                                                    <button type="button" class="btn btn-success" id="button_upload" onclick="FunctionImportExcel()"><i class="bi bi-upload"></i> Import Models </button>
                                                    <input type="file" id="import_excel" name="import_excel" style="display:none;">
                                                </form>&nbsp;&nbsp;
                                                <form action="{{ route('EmfgUpdateModelsATAC.export', $permissionName) }}" method="POST" name="form" id="export_excel_form">
                                                    @csrf
                                        ...
                                        {{-- FORM  ACTION = VIEW --}}
                                        {{-- =============================================================== --}}
                                        <form method="POST" action="{{ route('EmfgUpdateModelsATAC.show', $permissionName) }}" id="myForm">
                                            @csrf
