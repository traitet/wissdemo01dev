            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h5 mb-0 text-gray-800">【 Navigation Item 】</h1>
                    </div>
                    {{-- ========================================================= --}}
                    {{-- Alert  message --}}
                    {{-- ========================================================= --}}
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="text-right mb-4">
                                        <a class="btn btn-success" href="{{ route('navigationitems.create') }}"> +
                                            New Item</a>
                                    </div>
                                            ...
                                            <tbody>
                                                @foreach ($navigationItems as $navigationItem)
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <form
                                                                action="{{ route('navigationitems.destroy', $navigationItem->id) }}"
                                                                method="POST">
                                                                {{-- <a class="btn btn-primary" href="{{ route('navigationItems.edit',$navigationItem->id) }}">Edit</a> --}}
                                                                <a class="btn btn-danger btn-sm"
                                                                    href="{{ route('navigationitems.edit', $navigationItem->id) }}"><i
