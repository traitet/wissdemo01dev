                                        ...
                                        <div class="card-body">
                                            <div class="form-group float-right">
                                                <div class="row">
                                                    ...
                                                    @csrf
                                                        <button type="button" class="btn btn-success" id="button_upload" onclick="FunctionImportExcel()"><i class="bi bi-upload"></i> Import Pallets </button>
                                                        <input type="file" id="import_excel" name="import_excel" style="display:none;">
                                                    </form> &nbsp;&nbsp;
                                                    <form action="{{ route('EmfgUpdatePalletsATAC.export', $permissionName) }}" method="POST" name="form" id="export_excel_form">
                                                        @csrf
