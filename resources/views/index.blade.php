        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">WISS Manual</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <p>Good day every one,</p>
                                <p class="mb-0">Welcome to Web IT Self Service of Aisin Group. Click in this link for <a target="_blank"
                                    rel="nofollow" href="assets/User Manual WISS R1.pdf" >WISS User Manual</a>, When you
                                have question and concerns point please infrom to us for improvement.</p>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">WISS SDR</h6>
                        </div>
                        <div class="card-body">
                            <div class="text-center">
                                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                src="{{ asset('theme/img/WISS concept.png') }}" alt="...">
                            </div>
                            <p>System Overview</p>
                            <p class="mb-0">In finally working Web IT Self Service, Integrate and support many system in Aisin Group</p>
                        </div>
                    </div>
